...
import 'package:owomark/models/data.dart';
...
class _SingleProductState extends State<SingleProduct> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        child: ListView.builder(itemCount:product.length,itemBuilder: (BuildContext context,int index){
          ...
          return SingleChildScrollView(
            // height: double.infinity,
              ...
              child:Column(
                children: <Widget>[
                  Image.network(producturl+item.imageUrl,height: 300,width: MediaQuery.of(context).size.width*5,),
                  ListTile(title: Text('Product Title',style: TextStyle(
                  ...
                  Divider(),
                  ListTile(title: Text('Product M.R.P',style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 18
                  ),),trailing: Icon(Icons.arrow_forward_ios),),
                  ListTile(
                  ...
                  Divider(),
                  ListTile(title: Text('Product Discount ',style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 18
                  ),),trailing: Icon(Icons.arrow_forward_ios),),
                  ListTile(
